...
export const login = (username, password) => async dispatch => {
    const config = {
        headers: {
            ...
            'Access-Control-Allow-Origin': `${process.env.REACT_APP_API_URL}accounts/login, http://127.0.0.1:8000/accounts/register, http://127.0.0.1:8000/accounts/authenticated, http://127.0.0.1:8000/profile/user,`,
